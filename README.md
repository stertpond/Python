...
GitHub is the worlds largest source code repository and is accessible to everyone at no charge. It provides an easy and effective way to share source code and also works very well with VS Code.
Once you have Python working with VS Code then we can look at sharing code using Git. :)
