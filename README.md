...
- Read [this](https://code.visualstudio.com/docs/python/python-tutorial#_install-a-python-interpreter) to verify the Extension and Compiler are correctly installed 
